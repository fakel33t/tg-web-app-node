...
const token = '6426016499:AAFvYmIXTvnajQFBDrwZF4FgchQn4ZSpUAE';
const webAppUrl = 'https://stellar-toffee-bf20d9.netlify.app/';
  ...
  if(text === '/start') {
    ...
    if(msg?.web_app_data?.data) {
      try {
        ...
        console.log(data)
        await bot.sendMessage(chatId, 'Спасибо за ваш заказ!')
